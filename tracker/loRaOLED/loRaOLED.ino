...
/* OTAA para*/
uint8_t devEui[] = { 0x60, 0x81, 0xF9, 0x54, 0xC4, 0x47, 0x8E, 0x50};
uint8_t appEui[] = { 0x60, 0x81, 0xF9, 0x8F, 0x0D, 0x52, 0x3E, 0xDC};
uint8_t appKey[] = { 0x99, 0x65, 0xBE, 0xA8, 0xF4, 0x0D, 0x92, 0x4A,
                    0x43, 0x7E, 0x86, 0x76, 0x32, 0x89, 0xF3, 0x0D};
 ...
 uint32_t devAddr =  ( uint32_t )0x01485B2B;
